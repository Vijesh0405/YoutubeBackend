...
import { asyncHandler,ApiError,ApiResponse,checkEmailFormat} from "../utils/index.js";
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    if (!coverImage) {
        throw new ApiError(500, "Something went wrong while uploading coverImage file at updateUserCoverImage")
    }
