...
const toggleVideoLike = asyncHandler(async (req, res) => {
  ...
  if (!likedVideo) {
    ...
    try {
      ...
      throw new ApiError(
        500,
        "Internal Server Error,during creating videoLike"
      );
    }
  }
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        { isLiked: false, videoLike: likedVideo },
...
const toggleCommentLike = asyncHandler(async (req, res) => {
  ...
  if (!likedComment) {
    ...
    try {
      ...
      throw new ApiError(
        500,
        "Internal Server Error,during creating commentLike"
      );
    }
  }
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        { isLiked: false, commentLike: likedComment },
...
const toggleTweetLike = asyncHandler(async (req, res) => {
  ...
  if (!likedTweet) {
    ...
    try {
      ...
      throw new ApiError(
        500,
        "Internal Server Error,during creating tweetLike"
      );
    }
  }
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        { isLiked: false, tweetLike: likedTweet },
